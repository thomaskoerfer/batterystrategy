...
reported economics. Do not feed accounting back into forecasting, optimization
or live commands without an approved contract and impact analysis. Do not
infer missing prices as zero or advance counters while prices are absent.
