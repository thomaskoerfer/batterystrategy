...
Do not import forecasting or optimizer implementations, inspect battery state,
create plans or influence live commands. Never replace complete published
...
Use normalized provider roles and never commit account identifiers, locations,
private endpoints or installation-specific tariff entities.
