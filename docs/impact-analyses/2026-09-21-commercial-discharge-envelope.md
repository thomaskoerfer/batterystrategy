...
Status: implemented for the established and unified optimizers; no contract
change.

## Problem

The established optimizer derived discharge permission from planned load,
future planned charge and explicit reservation heuristics. The unified
...
export. The unified optimizer does not inherit that floor or the removed PV
recovery heuristics.
